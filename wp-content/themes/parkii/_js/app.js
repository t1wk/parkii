...
// Unbind keydown have been removed to fix this issue: https://github.com/zdfs/toscani/issues/35
	...
	$.fn.paymentInfo = function (method) {
		...
		helpers = {
			...
			creditCardComplete: function () {
				...
				$(element)
					.unbind("blur focus click keypress")
			...
			zipComplete: function () {
				...
				// Make the Donation button appear
				$("#donationform").addClass("four");
				...
				return this.each(function () {
					...
					$(this)
						...
						if(opts.cardInstruction) {
							//if(!window.matchMedia("(min-device-width : 414px)").matches){
								$(this).
